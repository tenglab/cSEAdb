...
Super enhancers (SEs) have been found as critical regulators in human cancers. Previous studies reported that, instead of treating each SE as a single unit, considering the dynamics of their internal components (i.e., constituent enhancers or CEs), provides better characterization of SE alterations. Here, we extend these analysis to pan-cancer datasets to identify cancer-specific SEs by fully utilizing SE internal dynamics and computationally modeling active statuses of enhancers. 
...
cSEAdb includes the following files:
  ...
  1. ce_bed: a merged constituent enhancer BED file from 60 cell lines.
  1. cell_cancer_meta: metadata of cell line and cancers of 60 cell lines.
  1. ce_signal
  1. ce_mixture_model_cell
  1. se_specificity
  1. gene_promotor
